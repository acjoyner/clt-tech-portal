                  ...
                  <tr key={item.id} className="border-b-2 border-black">
                    ...
                    <td className="p-4 text-center space-x-2">
                      <button
                        ...
                        className="bg-yellow-400 border-2 border-black px-2 py-1 font-black text-[10px] uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] text-black"
                      >
                        Specs
                      </button>
                      <button
                  ...
                  <tr key={quote.id} className="border-b-2 border-black">
                    ...
                    <td className="p-4 text-center space-x-2">
                      <button
                        ...
                        className="bg-green-500 border-2 border-black font-black px-4 py-1 text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
                      >
                        BUY
                      </button>
                      <button
                        onClick={() => handleBuyLead(quote, 0)}
                        className="bg-blue-500 border-2 border-black font-black px-4 py-1 text-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
                      >
                        RECYCLE
                      </button>
                    </td>
            ...
            {activeModal.type === "buy" && (
              <>
                ...
                <input
                  ...
                  type="number"
                  placeholder="$ Amount"
                  className="w-full border-4 border-black p-4 text-2xl font-black mb-6"
                />
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex-1 bg-green-500 border-4 border-black p-4 font-black"
                  >
                    CONFIRM
                  </button>
                  <button
                    onClick={() => setActiveModal(null)}
                    className="flex-1 bg-gray-200 border-4 border-black p-4 font-black"
                  >
                    CANCEL
                  </button>
                </div>
            ...
            {activeModal.type === "publish" && (
              <>
                ...
                <input
                  ...
                  className="w-full border-4 border-black p-4 text-3xl font-black mb-6"
                />
                <button
                  onClick={() =>
                    handlePublish(
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border-2 border-black p-2 font-black text-green-700"
                    />
                  </div>
                  <div>
                    <label className="text-[10px] font-black uppercase text-gray-400">
                    ...
                    <input
                      ...
                      className="w-full border-2 border-black p-2 font-black text-blue-700"
                    />
                  </div>
                </div>
                <button
                  ...
                  className="w-full bg-yellow-400 border-4 border-black p-4 font-black uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
                >
                  Save & Update
                </button>
                <button
