      ...
      <section className="mb-16">
        ...
        <div className="border-4 border-black overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          <table className="w-full text-left">
            ...
            <tbody>
              {filterData(inventory.filter((i) => i.status !== "sold")).map(
                (item) => (
        ...
        <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-200 bg-red-600 border-8 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center min-w-[320px]">
          ...
          <div className="flex gap-4 w-full">
            <button
              ...
              className="flex-1 bg-white text-black border-4 border-black p-3 font-black uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
            >
              Yes, Delete
            </button>
            <button
              onClick={() => setItemToDelete(null)}
              className="flex-1 bg-gray-200 text-black border-4 border-black p-3 font-black uppercase"
            >
              Cancel
            </button>
          </div>
