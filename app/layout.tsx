...
export const metadata: Metadata = {
  ...
  description: 'The #1 place in Charlotte, NC to sell used laptops, recycle old electronics, and get expert repairs.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        {/* Replace GTM-XXXXXXX with the ID Google gives you after you click 'Create' */}
      ...
      <body className="bg-white text-black antialiased">
        {/* GTM Noscript - backup for users with JavaScript disabled */}
        <noscript>
          <iframe 
